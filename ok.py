...
CREATOR = "Credit is everything for a developerr. - Subscribe on YouTube @LazyDeveloper"
BotCode = "8ade4ae1e3f1902905b9ea230807613476ad635a84bc01678dfdc1fd7807079a"
...
def verify():
    ...
    if computed_hash != stored_hash:
        raise Exception("Credit is everything for a developerr. - Subscribe on YouTube @LazyDeveloper ❤.")
    print("Credit is everything for a developerr. - Subscribe on YouTube @LazyDeveloper ❤.")
